        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsBasic = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppUsers_Batches_BatchId",
                        column: x => x.BatchId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsEntranceExam = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Images_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Question_Text = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    Opt1_key = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    Opt1_value = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    Opt2_key = table.Column<int>(type: "int", nullable: false, defaultValue: 2),
                    Opt2_value = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    Opt3_key = table.Column<int>(type: "int", nullable: false, defaultValue: 3),
                    Opt3_value = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    Opt4_key = table.Column<int>(type: "int", nullable: false, defaultValue: 4),
                    Opt4_value = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    Valid_Opt_key = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Subject_Course", x => new { x.SubjectId, x.CourseId });
                    table.ForeignKey(
                        name: "FK_Subject_Course_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Subject_Course_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConsultRegistrations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ConsultRegistrations_AppUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ExamRequired = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Student_Course", x => new { x.UserId, x.CourseId });
                    table.ForeignKey(
                        name: "FK_Student_Course_AppUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsShown = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    HasPassed = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    AppUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppUser = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AppUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Student_In_Exam", x => new { x.UserId, x.ExamId });
                    table.ForeignKey(
                        name: "FK_Student_In_Exam_AppUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Student_In_Exam_Exams_ExamId",
                        column: x => x.ExamId,
                        principalTable: "Exams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionExam", x => new { x.QuestionId, x.ExamId });
                    table.ForeignKey(
                        name: "FK_QuestionExam_Exams_ExamId",
                        column: x => x.ExamId,
                        principalTable: "Exams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionId = table.Column<int>(type: "int", nullable: false),
                    ExamId = table.Column<int>(type: "int", nullable: false),
                    Answer_value = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AppUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Student_Answer_Exams_ExamId",
                        column: x => x.ExamId,
                        principalTable: "Exams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Student_Answer_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentStatus_CourseRegistrations_CourseRegistrationId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "3436425e-44b7-44f9-b974-df50ae877fbf", "Administrator Role", "trung.nguyen@gmail.com", "trung.nguyen@gmail.com" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, null, null, "09fb914a-bae9-4559-99ba-e96a2f52d237", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(1995, 8, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), "trung.nguyen@gmail.com", true, "Trung", " ", "Nguyen", false, null, "trung.nguyen@gmail.com", "admin", "AQAAAAEAACcQAAAAEOsS2jkjm8XmCtAI8Jk8/BnARzvxm4R2/IlZXTh2s1aou/umpj9H87ByPKKXd+HC0A==", null, false, "", false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsultRegistrations_UserId",
                table: "ConsultRegistrations",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Images_SubjectId",
                table: "Images",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentStatus_CourseRegistrationId",
                table: "PaymentStatus",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Student_In_Exam_ExamId",
                table: "Student_In_Exam",
                column: "ExamId");

            migrationBuilder.CreateIndex(
                name: "IX_Subject_Course_CourseId",
